      ...
      <Card title={this.props.data.title}>
            ...
            {this.props.data.addNewDataUrl ? (
              <FormItem>
                <Button
                  ...
                  icon={<PlusOutlined />}
                  onClick={() =>
                    this.props.history.push(this.props.data.addNewDataUrl)
                  }
                >
        ...
        {this.props.data.expandable ? (
          <Table
            ...
            expandable={{
              expandedRowRender: (record) => (
                <p style={{ margin: 0 }}>{this.expandedRowData(record)}</p>
              ),
            }}
            rowKey="id"
            rowSelection={{
          ...
          <Table
            ...
            rowKey="id"
            rowSelection={{
              type: this.props.data.selectionType
                ? this.props.data.selectionType
                : "radio",
              ...rowSelection,
            }}
          />
